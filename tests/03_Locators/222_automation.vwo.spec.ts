// scenario : open the vwo app and enter incorrect email /password and it should throw an error - incorrect creds with submit button and verify the error message
...
test("locators are lazy, strict, and auto-wait", async ({ page }) => {
    ...
    let usernameField = page.getByRole("textbox", { name: "Enter email ID" });
